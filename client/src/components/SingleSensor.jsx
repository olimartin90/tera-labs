...
class SingleSensor extends Component {
      ...
      axios
        .post(
          `http://localhost:3000/api/v1/users/${
            this.props.group.user_id
          }/group_sensors/${this.props.group.id}/single_sensors/${
        ...
        .then(response => {
          ...
          console.log(">>> postDataPointCompleted --------->");
        })
  ...
  updateChart() {
    ...
    this.chart.options.data[0].legendText = ` ${this.props.sensor.data_type}: ${
      this.state.yValue
    } ${this.state.unit}`;
